...
/*
 * Design Pattern -> coleção de boas praticas (padrões) OO (orientacao a objetos)
 ...
 *3º  Toda classe deve possuir no minimo um construtor vazio + um construtor para todos os atributos (cheio). Em source -> Generate Constructor fieds
...
public class Aluno {
	...
	public void setRm(int rm) { // preencher
		this.rm = rm;  // usa o this para apontar quem é o atributo
	}
