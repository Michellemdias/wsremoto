...
public class Notas {
	 ...
	 * "Aluno xxxx, sua média obtida foi: xxxx para 10 faltam: xxx pontos"
	 */
	...
	public static void main(String[] args) {
		...
		System.out.printf ("Aluno %s, sua média obtida foi: %.2f para 10 faltam %.2f", aluno,media,10-media);
	}
