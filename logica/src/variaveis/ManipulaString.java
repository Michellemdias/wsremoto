...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Do 2º ao 4º: " + email.substring(1,5));
		...
		System.out.println("Comparação com case sensitive: " + email.equals("xpto@itau.com.br"));
		System.out.println("Comparação sem case sensitive: " + email.equalsIgnoreCase("xpto@itau.com.br"));
